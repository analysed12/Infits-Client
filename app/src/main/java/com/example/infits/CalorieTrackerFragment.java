    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textviewLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_calorieTrackerFragment_to_foodDetailsFragment);
            }
        });
        ...
        imgback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_calorieTrackerFragment_to_dashBoardFragment);
            }
        });
